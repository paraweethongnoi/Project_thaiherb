...
class Showlistvine extends StatefulWidget {
  final String showstyle;

  Showlistvine(this.showstyle);

  @override
  _ShowlistvineState createState() => _ShowlistvineState();
}

class _ShowlistvineState extends State<Showlistvine> {
